...
生成构造器:选中你要创建getter，setter的字段,然后选择generator，可以拖选住你想要生成get、set方法的属性，点击完成即可自动生成get和set方法。
    (菜单栏->generator 或者 点击右键->generator) 
...
public class Custom {
    public static void main(String[] args) {
        ...
        arrayList.add(0, "111");//17 提示方法参数类型(Parameter Info)    ctrl+alt+/
    }
}
